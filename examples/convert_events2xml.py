...
root_folder = "/Users/tancykao/Dropbox/05_Woolcock_DS/AnalyzeTools/turtleRef/OSA_TR15DC/wonambi/"

# Folder where your JSON files
json_folder = root_folder + "spindle_results/"

# XML annotation file (should be in the root folder)
existing_xml = root_folder + "OSA_TR15DCR_clean_rebuilt.xml"

# List of JSON files you want to convert 
json_files = [
    json_folder + "spindles_Ferrarelli2007_9.0-12.0Hz_NREM2NREM3_E4.json",
    json_folder + "spindles_Ferrarelli2007_9.0-12.0Hz_NREM2NREM3_E5.json",
]
