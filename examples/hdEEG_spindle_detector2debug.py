...
Parameters:
    ...
    - test_channels (list): List of EEG channels to analyze.
...
# Add the site-packages directory for debugging
# This is a workaround to add the site-packages directory to the system path
sys.path.append('/Users/tancykao/miniconda3/envs/sleep310/lib/python3.10/site-packages')
...
root_dir = "/Users/tancykao/Dropbox/05_Woolcock_DS/AnalyzeTools/Coupling_python/CFC_080920/individual/01js/ses-1/"
